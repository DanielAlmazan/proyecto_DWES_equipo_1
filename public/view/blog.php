        ...
        <div class="col-xs-12 col-sm-8 row">
           <div class="col-xs-12 col-sm-12">
             <div class="post">
               <div class="post-heading">
                 <span>6 JANUARY</span>
                 <img class="img-responsive" src="../res/images/blog/landscape.jpg" alt="post's picture">
               </div>
               <div class="post-body">
           ...
           <div class="col-xs-12 col-sm-12">
             <div class="post">
               <div class="post-heading">
                 ...
                 <img class="img-responsive" src="../res/images/blog/family.jpg" alt="post's picture">
               </div>
               <div class="post-body">
           ...
           <div class="col-xs-12 col-sm-12">
             <div class="post">
               <div class="post-heading">
                 <span>8 MARCH</span>
                 <img class="img-responsive" src="../res/images/blog/elephant.jpg" alt="post's picture">
               </div>
               <div class="post-body">
           ...
           <div class="well">
            ...
            <hr>
             <div class="post">
               <div class="post-heading">
                 <span>10 APRIL</span>
                 <img class="img-responsive" src="../res/images/blog/wedding.jpg" alt="post's picture">
               </div>
               <div class="post-body">
                 <span>
                 <i class="fa fa-heart sr-icons"></i> 10
             ...
             <div class="post">
               <div class="post-heading">
                 <span>12 MAY</span>
                 <img class="img-responsive" src="../res/images/blog/woman.jpg" alt="post's picture">
               </div>
               <div class="post-body">
                 <span>
                 <i class="fa fa-heart sr-icons"></i> 10
